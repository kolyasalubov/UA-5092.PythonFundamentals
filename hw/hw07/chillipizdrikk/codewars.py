...
# and returning Wow this is really amazing. String should be capitalized and 
# properly spaced.
...
# Words are always separated by a single space. As the input may have trailing 
# spaces, you will also need to ignore unneccesary whitespace.
...
# away! You know that on average, your car runs on about 25 miles per gallon. There 
# are 2 gallons left. Considering these factors, write a function that tells you if 
...
# first argument (body) - otherwise the tail wouldn't fit! If the tail is right return 
